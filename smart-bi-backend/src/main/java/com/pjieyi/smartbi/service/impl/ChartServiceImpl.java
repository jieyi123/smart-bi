...
import com.pjieyi.smartbi.bizmq.BIMessageProducer;
...
public class ChartServiceImpl extends ServiceImpl<ChartMapper, Chart>
    ...
    //异步调用 消息队列
    @Override
    public BiResponse genChartAsyncMq(MultipartFile multipartFile, GenChartByAiRequest genChartByAiRequest, User loginUser) {
        //每个不同的业务进行不同的限流
        redisLimiterManager.doRateLimit("genChartAi_" + loginUser.getId());
        if (loginUser == null) {
            throw new BusinessException(ErrorCode.NOT_LOGIN_ERROR);
