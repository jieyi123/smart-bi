...
import {adminListChartByPageUsingPost, listChartByPageUsingPost} from "@/services/smart-bi-backend/chartController";
...
const MyChartPage: React.FC = () => {
  ...
  const loadData = async () => {
    ...
    setLoading(true);
    try {
      const res = await adminListChartByPageUsingPost(searchParams);
      if (res.data) {
